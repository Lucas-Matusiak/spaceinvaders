...
import fr.unilim.iut.spaceinvaders.domain.Dimension;
import fr.unilim.iut.spaceinvaders.domain.Position;
import fr.unilim.iut.spaceinvaders.domain.SpaceInvaders;
...
public class SpaceInvadersTest {
    ...
    public void initialisation() {
	 ...
	 @Test
	  ...
	  @Test
	    public void test_VaisseauImmobile_DeplacerVaisseauVersLaDroiteAvecVitessse() {
	  ...
	  @Test
	     public void test_MissileBienTireDepuisVaisseau_VaisseauLongueurImpaireMissileLongueurImpaire() throws Exception {
